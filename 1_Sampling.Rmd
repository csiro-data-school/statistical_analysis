...
Each of these functions are called with an argument `n` for the number of observations to record, as well 
...
> Take 6 separate samples of 30 observations each for your two distributions. Histogram the observations.
...
# Repeat ggplot version for the exponential distribution
_____
...
* `sample_height(n)`: Sample `n` values from a human height distribution
